...
uint256 constant VK_HASH = 0x04e2333361a7bad5af292344132044483b9807dc4dde2728dc1e172c05f96991;
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x00eb0c90294a9a44158235a84418eb714da5be387e6e538496f1f356abdb3090
                ),
                y: uint256(
                    0x01bcf3c2da41f17604ea811b0e0315f6b2e7b178bae9ae1f5fae8a545835c472
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x2eba7eee1ac5ae2884d5a30314a4a2bf51b34af79343e47fc75ea97418863b33
                ),
                y: uint256(
                    0x06825d7d0cef11ad802c0455ffc3a1861b4df8babb816c568b9c5022d834c77c
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x1fd48d604442652ef46ecd347e204ba725e3ebe59a68fff211d9120a1384d563
                ),
                y: uint256(
                    0x034cc895b67f13d10985a3cfea8db5801464f5a643c41c519ec1eb563be1ce4a
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x011a4eda7ce5e63faff546aab7bafb4ea8d8281d76293fb5dfddf867367484c4
                ),
                y: uint256(
                    0x2023192913a58f692c32e93d9b0b511018295edf4fd69616557d63e096392aa6
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x2aa22319f992df09515320838e9df68e25f31d645f55c4dfd5dcaf613871fe2f
                ),
                y: uint256(
                    0x209789d9f4961703b5e465d351c342233bd26c3f0fe7d3258c515771d6973e70
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x00244c40ccbecd1b89fd6a50582850f6dcf16e2ee05fb77b9822c980608f0e7b
                ),
                y: uint256(
                    0x138e2719f026cb60fc1a8f3eb7dad493bf6ad00dcabac30d5af9e80d23c5ace6
                )
            }),
            ...
            qArith: Honk.G1Point({
                x: uint256(
                    0x2c21e47fec9cd7f942c621d1a25e7eb196587fb92d8c1c1ecac5dd11af7d47e7
                ),
                y: uint256(
                    0x1f9a2367485fef16b38755f74465d2d33e34643b7100e2cfa27cc8d3ddfa3280
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x0a822351b456f1e27dabe9a1f73487bb65ccab8d891b9b099b602ead7f5072c1
                ),
                y: uint256(
                    0x1db62bc2ec66a27c7676531a5e7b1f05bcfa1111f3c9994897dd32c647776ee1
                )
            }),
            qElliptic: Honk.G1Point({
                x: uint256(
                    0x22e3117361732805279511ac6cdd665ac75d33ff47dc4fb9aa1b9037b64e79e0
                ),
                y: uint256(
                    0x17cb0ab856a265fc1ebc21c6a942737b422869b768f54b2ce2498bc7ab47933b
                )
            }),
            qMemory: Honk.G1Point({
                x: uint256(
                    0x293d308aca44b1ad325f540198c9cb8873d568d96a1c6c333abc0fa3ec635881
                ),
                y: uint256(
                    0x046fedafc12d8252830691b674d0095fc561352454ab30a0223bbdf63a905490
                )
            }),
            qNnf: Honk.G1Point({
                x: uint256(
                    0x3059212ff18b70d6b1c903cab72633e9e2ea303c83230707d0bd9b50098af814
                ),
                y: uint256(
                    0x286343158b2d7d3062bf82f96220a5b2e35281b49bde39ca8a20189b540ec9a3
                )
            }),
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x23f20c7a5c85625f1d1825107838059258cdd4f91d8d1c48e0ff9db86528d342
                ),
                y: uint256(
                    0x05364fe533d93dba36d4184a3ae7fc25fb9b476bf57447769dbcefcdcc0241fb
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x2182de918515aa94f6574d9af40117301128dbe00baaa094766a2e0c17fa2f29
                ),
                y: uint256(
                    0x04b0bbbecbd81844a3dbae28c9ed0cb2af72bb876ca3ab8d572447f5dd086de4
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x050a5eada84d42fd27df8af75f06a23be11e441a6543869e5ae8db3862300e83
                ),
                y: uint256(
                    0x1a82d3b74cfd8cb23ba2648cbc9ab2ed53486f25f69d6dcafb70ec3d165a5225
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x17d76d3140f8a533ab18165d115a6fc913b6b60deb0e7b2d4d41bc00ab1e2db5
                ),
                y: uint256(
                    0x263d426718d572684177d11d94ad8721d886404e264a58cff9c318e906a15881
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x0a306fd64cfe2871240bf060733e8b5ccc74626307e6a71c4148ba4867be22bd
                ),
                y: uint256(
                    0x2977b87e7d6b3d087df08f53fa509022809e8d2d1aab59428c2f12583d3dbe7c
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x057529560e0af98145193c23410f2e9f085ab36644aa2c928eb6e3c215ed5b89
                ),
                y: uint256(
                    0x19f62233c8696a8a93e4bb95426fc44e1b53030e6336b4d04b16a7cf034bb10b
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
                    0x004067623374b7c3965c7d8444b57ac2d81269c7eb3cb4f7b16568b2f8234c96
                ),
                y: uint256(
                    0x0e605f3ad72203e21301ef1b5333cae1d8063220d1996854beb0c4fbc33bba9d
                )
            }),
            t2: Honk.G1Point({
                x: uint256(
                    0x17aafa80bf54a7e6cc66472f9ccd70efa5044207a95191716ba0195b5a432266
                ),
                y: uint256(
                    0x233ecaca2ddbebb0484a44e6f55b8c8614c7b5e0ce31b51d59d6b21322a307a1
                )
            }),
            t3: Honk.G1Point({
                x: uint256(
                    0x046d00a14d5c2e99d48c85c441284b5dfef894fba87965c1c75b9a5a7cf0fdde
                ),
                y: uint256(
                    0x2113297215872f507a7668059f801ac9877e73cb6dcab3703c5f68b404abeded
                )
            }),
            t4: Honk.G1Point({
                x: uint256(
                    0x0765bf6645e4cf63f05d9b0efd06acebce309c685a3b05e613574ccd7316677c
                ),
                y: uint256(
                    0x09770f145625290cdcb08bae4e6f0a26897b5988fbaf9529e0a3326bfdb537ae
                )
            }),
            id1: Honk.G1Point({
                x: uint256(
                    0x2d0b8dc3d1e1f3c5e2a08ab2436d2904515616737d6d9710c0b7e2781778e00a
                ),
                y: uint256(
                    0x227190c81c30b6865a17c2a1fdc5262bbdfd71fba1649c4ea9b861e98098f6eb
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x03e82f0c954567215efc59217268022b262d872afe244c9c08eb2997c4c06d28
                ),
                y: uint256(
                    0x13686149577f92f75750b83d38590da233da51ae844e15fea0571ba39ed0709d
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x10d07c3073e583e4740d020d731ce13769db374004e581e3fd258e2144e62c13
                ),
                y: uint256(
                    0x1dc5f5bc146ea60c26ff43b1c532222bf803de41b3c167c63f05188595eab047
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x24017c80b02712e896b8f4b59e5f0f75b5b2cef3244eb7e4a5e080d9939db506
                ),
                y: uint256(
                    0x12769011fdf8ef3a70f79134389800b9bd4676c9cba6e48857ea6c90dd2c2718
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x191b5886160a7bd37c7efdae7f1265c9dd423419c6057eff6cd956efdaed34eb
                ),
                y: uint256(
                    0x019b474422af6363ee8efec7e5f24c467f2a0419ec47ad80ef22ac5334f73dc2
                )
            })
        });
        return vk;
...
library TranscriptLib {
    ...
    function generateShplonkZChallenge(
        Honk.Proof memory proof,
        Fr prevChallenge
    ) internal view returns (Fr shplonkZ, Fr nextPreviousChallenge) {
...
contract HonkVerifier is
    BaseHonkVerifier(N, LOG_N, VK_HASH, NUMBER_OF_PUBLIC_INPUTS)
{
    function loadVerificationKey()
        internal
        pure
